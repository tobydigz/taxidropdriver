...
import com.digzdigital.eservicedriver.messaging.MessageService;
import com.digzdigital.eservicedriver.messaging.MessagingActivity;
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(KEY_STATUS)) {
            if (sharedPreferences.getBoolean(KEY_STATUS, false)) {
                ...
                LocalBroadcastManager.getInstance(this).registerReceiver(receiver, new IntentFilter("com.digzdigital.eservicedriver.MainActivity"));
            } else {
                stopTrackingService();
            }
